...
Friend Class frmNumLeft
    ...
    Private Sub frmNumLeft_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        If numQleft = 10 Then
            Label1.Text = "You are 1/3 way there to winning the game. You will get at least 16 points!"

        End If
        If numQleft = 5 Then
            Label1.Text = "You are 2/3 way there to winning the game. You will get at least 512 points!"
        End If
